...
DECK.register({
  ...
  <div class="grid cols-3 mt">
    ...
    <div class="card accent" data-anim="pop" style="--i:2"><span class="iconbox">${icon('cycle')}</span><h3>Prototipado evolutivo <span style="font-weight:500;color:var(--text-soft)">(Sommerville, 2011)</span></h3><p>Fase 3: baja fidelidad → funcional → sistema final.</p></div>
