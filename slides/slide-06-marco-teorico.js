...
DECK.register({
  ...
  <div class="grid cols-3 mt">
    ...
    <div class="card accent" data-anim="pop" style="--i:3"><span class="iconbox">${icon('chip')}</span><h3>MCP</h3><p>Protocolo que estandariza el acceso del LLM a los datos.</p></div>
